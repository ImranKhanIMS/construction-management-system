    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">Update House</h1>
                ...
                <div class="col-md-12 text-center">
                  ...
                  <div>
                      ...
                      <div class="row">
						...
						<div class="col-md-12 mb-3">
							<div class="form-group">
								<input style="color:blue;" type="text" name="location" class="form-control" id="name" placeholder="House New Location">
							</div>
						</div>
						
						<div class="col-md-12 mb-3">
							<div class="form-group">
								<input style="color:blue;" type="text" name="date" class="form-control" id="name" placeholder="New Starting Date">
							</div>
						</div>
                        ...
                        <div class="col-md-12">
                          <button name="submit" type="submit" class="button button-a button-big button-rouded">Update House</button>
                        </div>
                      </div>
                    </form>
...
<?php
	...
	if (isset($_POST['submit']))
	{
		...
		if ($num!="" && $img!="")
		{
			...
			$query = "UPDATE houses set image='$img' WHERE number='$num'";
			$query_exec=mysqli_query($conn,$query);
		}
		
		if ($num!="" && $loc!="")
		{
			$query = "UPDATE houses set location='$loc' WHERE number='$num'";
			$query_exec=mysqli_query($conn,$query);
		}
		
		if ($num!="" && $dat!="")
		{
			$query = "UPDATE houses set date='$dat' WHERE number='$num'";
			$query_exec=mysqli_query($conn,$query);
		}
	}
?>