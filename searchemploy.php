				  ...
				  <form action='search.php' method='POST'>
                      <div class='row'>
                        ...
                        <div class='col-md-12 mb-3'>
							...
							<div class='col-md-12 mb-3'>
							<div class='form-group'>
								<input style='color:blue;' type='text' name='housenumber' class='form-control' id='name' placeholder='House Number : ".$id."'>
							</div>
						</div>
						
                        <div class='col-md-12'>
						<button name='submit' type='submit' class='button button-a button-big button-rouded'>Search Employ</button>
						</div>
							</form>
						";
				?>	
