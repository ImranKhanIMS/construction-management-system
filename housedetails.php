...
<body id="page-top">
      ...
      <div class='row'>
        <div class='col-sm-12'>
          <div class='title-box text-center'>
            <h2>
              All Detail's of Your Searched House
            </h2>
  ...
  echo "
		...
		/*All Employes in This House*/
		echo "<div class='col-md-12'>
          <div class='card card-blog'>
			<h3 align='center'>All Employes in This House</h3>
		  </div>
		  </div>";
		  
		$query1="select * from employes WHERE housenumber='$house'";
  ...
  echo "
		...
		/*All Stock's in This House*/
		echo "<div class='col-md-12'>
          <div class='card card-blog'>
			<h3 align='center'>All Stock's in This House</h3>
		  </div>
		  </div>";
		  
		$query2="select * from stocks WHERE housenumber='$house'";
  ...
  ?>
  <h4 align="right"><a style="color:white; padding:10px;" class="bg-info button-rouded" href="housedetail.php">Back</a></h4>
  </div>
  </section>
